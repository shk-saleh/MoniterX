        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 border-l-4 rounded" style={{ borderColor: '#00D4FF', backgroundColor: '#f0f3fd' }}>
                  <p className="text-gray-600 text-sm">Used RAM</p>
                  <p className="text-xl font-bold" style={{ color: '#00D4FF' }}>
                    {systemData?.memory?.used} GB
                  </p>
                </div>
                <div className="p-4 border-l-4 rounded" style={{ borderColor: '#FF6B6B', backgroundColor: '#f0f3fd' }}>
